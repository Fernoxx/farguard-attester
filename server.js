...
app.post("/attest", async (req, res) => {
  try {
    ...
    // 1️⃣ Check Farcaster user via Neynar
    const resp = await neynarClient.fetchBulkUsersByEthOrSolAddress({ addresses: [walletAddr] });
